...
do
    ...
    then
        ...
        $pmemddir -O -i prod.mdin -c mini.rst7 -p ${protein}.parm7 -phmdparm $toppar/input.parm -phmdout prod_${theta}_${thetx}.lambda -phmdstrt phmdstrt_${theta}_${thetx}.in -o prod_${theta}_${thetx}.mdout -r prod_${theta}_${thetx}.rst7 &
        wait
